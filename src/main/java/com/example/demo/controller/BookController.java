...
public class BookController {
    ...
    public ResponseEntity<List<Book>> searchDocumentsContaining(@PathVariable("query") String query) {
        List<Book> bookData = bookRepository.findByDescriptionContaining(query);
        if(bookData.isEmpty()){
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
        else{
